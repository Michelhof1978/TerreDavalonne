 ...
 */
class StatutOrderRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, StatutOrder::class);
    }
     ...
     */
    public function add(StatutOrder $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(StatutOrder $entity, bool $flush = true): void
    {
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?StatutOrder
    {
        return $this->createQueryBuilder('s')
            ->andWhere('s.exampleField = :val')
            ->setParameter('val', $value)
