 ...
 */
class MagieVerteOptionRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, MagieVerteOption::class);
    }

    public function add(MagieVerteOption $entity, bool $flush = false): void
    {
    ...
    public function remove(MagieVerteOption $entity, bool $flush = false): void
    {
